  ...
  return (
    <div>
      <div id="page1" className="py-1 ">
        <div
          ref={imageDivRef}
          className="absolute overflow-hidden lg:h-[20vw] h-[30vw] lg:rounded-3xl rounded-xl lg:w-[15vw] w-[25vw] lg:top-50 -top-80 lg:left-[30vw] left-[30vw]"
        >
          <img
            ref={imageRef}
      ...
      <div id="page2" className=" h-[60vh]">
        <div className="grid grid-rows-2 gap-2 font-[font2] font-bold text-2xl mt-[20vw] mx-[10vw]">
          <div className="grid grid-cols-3 gap-10">
            <h1>Expertise</h1>
            <h1>Stratégie Publicité Branding Design Contenu</h1>
          </div>
          <div className="grid grid-cols-3 gap-10">
            <h1>
