...
const FullScreenNav = () => {
  ...
  return (
    <div
      ref={fullScreenRef}
      id="fullscreennav"
      className="fullscreennav hidden text-white  h-screen w-full z-50 absolute"
    >
      ...
      <div ref={fullNavLinksRef} className="relative">
        ...
        <div className="bg-black">
          ...
          <div className="link origin-top relative border-y border-white bg-black">
            <h1 className="font-[font2] text-5xl lg:text-[8vw] text-center lg:leading-[0.8] lg:pt-10 pt-3 uppercase">
              Blogs
            </h1>
            <div className="moveLink absolute text-black flex top-0 bg-[#D3FD50]">
        ...
        <div className=" bg-black">
          <div className="mx-[2vw] flex gap-[23vw]">
